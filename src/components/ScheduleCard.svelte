...
>
    <div class="flex relative">
        ...
        <div class="flex items-center gap-4 relative">
            <div>
                <img src={schedule.img} alt={schedule.speaker}
                class="w-12 h-12 sm:w-16 sm:h-16 rounded-full object-cover border-2 border-indigo-400 shadow-md"/>
            </div>
            <div>
    ...
    <p class="text-indigo-400 text-semibold">{schedule.topic}</p>
